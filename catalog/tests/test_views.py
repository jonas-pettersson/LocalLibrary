...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(
            response, 'loaned_books_current_user_list.html')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_HTTP404_for_invalid_book_if_logged_in(self):
        ...
        login = self.client.login(
            username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(
            reverse('renew_book', kwargs={'pk': test_uid}))
    ...
    def test_uses_correct_template(self):
        ...
        # Check we used correct template
        self.assertTemplateUsed(response, 'book_renewal.html')
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        response = self.client.post(reverse('renew_book', kwargs={
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        response = self.client.post(reverse(
            'renew_book', kwargs={'pk': self.test_bookinstance1.pk}), {'renewal_date': date_in_past})
        self.assertEqual(response.status_code, 200)
